...
square[0] = new Square("", "", "white");
square[1] = new Square("Palladium", "$60", "#4B0082", 60, 3, 2, 10, 30, 90, 160, 250);
square[2] = new Square("Chor Bazaar", "", "white");
square[3] = new Square("BW Sea Link", "$60", "#4B0082", 60, 3, 4, 20, 60, 180, 320, 450);
square[4] = new Square("Income Tax", "", "white");
square[5] = new Square("Churchgate", "$200", "white", 200, 1);
square[6] = new Square("R City Mall", "$100", "#AACCFF", 100, 4, 6, 30, 90, 270, 400, 550);
square[7] = new Square("Ittefaq", "", "white");
square[8] = new Square("Phoenix Market City", "$100", "#AACCFF", 100, 4, 6, 30, 90, 270, 400, 550);
square[9] = new Square("High Street Phoenix", "$120", "#AACCFF", 120, 4, 8, 40, 100, 300, 450, 600);
square[10] = new Square("", "", "white");
square[11] = new Square("Cooperage", "$140", "purple", 140, 5, 10, 50, 150, 450, 625, 750);
square[12] = new Square("MTNL Services", "$150", "white", 150, 2);
square[13] = new Square("Brabourne Stadium", "$140", "purple", 140, 5, 10, 50, 150, 450, 625, 750);
square[14] = new Square("Wankhede Stadium", "$160", "purple", 160, 5, 12, 60, 180, 500, 700, 900);
square[15] = new Square("Dadar Stn", "$200", "white", 200, 1);
square[16] = new Square("JK House", "$180", "orange", 180, 6, 14, 70, 200, 550, 750, 950);
square[17] = new Square("Chor Bazaar", "", "white");
square[18] = new Square("Jatia House", "$180", "orange", 180, 6, 14, 70, 200, 550, 750, 950);
square[19] = new Square("Jindal House", "$200", "orange", 200, 6, 16, 80, 220, 600, 800, 1000);
square[20] = new Square("", "", "white");
square[21] = new Square("Jalsa Apt", "$220", "red", 220, 7, 18, 90, 250, 700, 875, 1050);
square[22] = new Square("Ittefaq", "", "white");
square[23] = new Square("Galaxy Apartments", "$220", "red", 220, 7, 18, 90, 250, 700, 875, 1050);
square[24] = new Square("Mannat Bungalow", "$240", "red", 240, 7, 20, 100, 300, 750, 925, 1100);
square[25] = new Square("Bandra Stn", "$200", "white", 200, 1);
square[26] = new Square("Trident Hotel", "$260", "yellow", 260, 8, 22, 110, 330, 800, 975, 1150);
square[27] = new Square("Oberoi Hotel", "$260", "yellow", 260, 8, 22, 110, 330, 800, 975, 1150);
square[28] = new Square("BEST Services", "$150", "white", 150, 2);
square[29] = new Square("Taj Hotel", "$280", "yellow", 280, 8, 24, 120, 360, 850, 1025, 1200);
square[30] = new Square("", "", "white");
square[31] = new Square("Trump Apt", "$300", "green", 300, 9, 26, 130, 390, 900, 110, 1275);
square[32] = new Square("Piramal Apt", "$300", "green", 300, 9, 26, 130, 390, 900, 110, 1275);
square[33] = new Square("Chor Bazaar", "", "white");
square[34] = new Square("Antilia Apt.", "$320", "green", 320, 9, 28, 150, 450, 1000, 1200, 1400);
square[35] = new Square("Andheri Stn", "$200", "white", 200, 1);
square[36] = new Square("Ittefaq", "", "white");
square[37] = new Square("Imperial I", "$350", "blue", 350, 10, 35, 175, 500, 1100, 1300, 1500);
square[38] = new Square("GST", "", "white");
square[39] = new Square("Imperial II", "$400", "blue", 400, 10, 50, 200, 600, 1400, 1700, 2000);
